...
echo Removing file lib\cmake\libbsoncxx-3.5.0\libbsoncxx-config.cmake
del lib\cmake\libbsoncxx-3.5.0\libbsoncxx-config.cmake || echo ... not removed
echo Removing file lib\cmake\libbsoncxx-3.5.0\libbsoncxx-config-version.cmake
del lib\cmake\libbsoncxx-3.5.0\libbsoncxx-config-version.cmake || echo ... not removed
echo Removing file lib\cmake\libbsoncxx-static-3.5.0\libbsoncxx-static-config.cmake
del lib\cmake\libbsoncxx-static-3.5.0\libbsoncxx-static-config.cmake || echo ... not removed
echo Removing file lib\cmake\libbsoncxx-static-3.5.0\libbsoncxx-static-config-version.cmake
del lib\cmake\libbsoncxx-static-3.5.0\libbsoncxx-static-config-version.cmake || echo ... not removed
...
echo Removing file lib\cmake\bsoncxx-3.5.0\bsoncxx_targets.cmake
del lib\cmake\bsoncxx-3.5.0\bsoncxx_targets.cmake || echo ... not removed
echo Removing file lib\cmake\bsoncxx-3.5.0\bsoncxx_targets-release.cmake
del lib\cmake\bsoncxx-3.5.0\bsoncxx_targets-release.cmake || echo ... not removed
echo Removing file lib\cmake\bsoncxx-3.5.0\bsoncxx-config-version.cmake
del lib\cmake\bsoncxx-3.5.0\bsoncxx-config-version.cmake || echo ... not removed
echo Removing file lib\cmake\bsoncxx-3.5.0\bsoncxx-config.cmake
del lib\cmake\bsoncxx-3.5.0\bsoncxx-config.cmake || echo ... not removed
...
echo Removing file lib\cmake\libmongocxx-3.5.0\libmongocxx-config.cmake
del lib\cmake\libmongocxx-3.5.0\libmongocxx-config.cmake || echo ... not removed
echo Removing file lib\cmake\libmongocxx-3.5.0\libmongocxx-config-version.cmake
del lib\cmake\libmongocxx-3.5.0\libmongocxx-config-version.cmake || echo ... not removed
echo Removing file lib\cmake\libmongocxx-static-3.5.0\libmongocxx-static-config.cmake
del lib\cmake\libmongocxx-static-3.5.0\libmongocxx-static-config.cmake || echo ... not removed
echo Removing file lib\cmake\libmongocxx-static-3.5.0\libmongocxx-static-config-version.cmake
del lib\cmake\libmongocxx-static-3.5.0\libmongocxx-static-config-version.cmake || echo ... not removed
...
echo Removing file lib\cmake\mongocxx-3.5.0\mongocxx_targets.cmake
del lib\cmake\mongocxx-3.5.0\mongocxx_targets.cmake || echo ... not removed
echo Removing file lib\cmake\mongocxx-3.5.0\mongocxx_targets-release.cmake
del lib\cmake\mongocxx-3.5.0\mongocxx_targets-release.cmake || echo ... not removed
echo Removing file lib\cmake\mongocxx-3.5.0\mongocxx-config-version.cmake
del lib\cmake\mongocxx-3.5.0\mongocxx-config-version.cmake || echo ... not removed
echo Removing file lib\cmake\mongocxx-3.5.0\mongocxx-config.cmake
del lib\cmake\mongocxx-3.5.0\mongocxx-config.cmake || echo ... not removed
...
echo Removing directory lib\cmake\bsoncxx-3.5.0
(rmdir lib\cmake\bsoncxx-3.5.0 2>NUL) || echo ... not removed (probably not empty)
echo Removing directory lib\cmake\libbsoncxx-3.5.0
(rmdir lib\cmake\libbsoncxx-3.5.0 2>NUL) || echo ... not removed (probably not empty)
echo Removing directory lib\cmake\libbsoncxx-static-3.5.0
(rmdir lib\cmake\libbsoncxx-static-3.5.0 2>NUL) || echo ... not removed (probably not empty)
echo Removing directory lib\cmake\libmongocxx-3.5.0
(rmdir lib\cmake\libmongocxx-3.5.0 2>NUL) || echo ... not removed (probably not empty)
echo Removing directory lib\cmake\libmongocxx-static-3.5.0
(rmdir lib\cmake\libmongocxx-static-3.5.0 2>NUL) || echo ... not removed (probably not empty)
echo Removing directory lib\cmake\mongocxx-3.5.0
(rmdir lib\cmake\mongocxx-3.5.0 2>NUL) || echo ... not removed (probably not empty)
...
cd ..
echo Removing top-level installation directory: D:\mongo-cxx-driver-r3.5\
(rmdir D:\mongo-cxx-driver-r3.5\ 2>NUL) || echo ... not removed (probably not empty)
