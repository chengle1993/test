...
#ifndef _MANAGEMENT_ORG_APACHE_QPID_BROKER_TOPICPOLICY_
#define _MANAGEMENT_ORG_APACHE_QPID_BROKER_TOPICPOLICY_
...
QPID_BROKER_CLASS_EXTERN class TopicPolicy : public ::qpid::management::ManagementObject
{
  private:
...
#endif  /*!_MANAGEMENT_TOPICPOLICY_*/
