...
#ifndef _MANAGEMENT_QUEUETHRESHOLDCROSSEDUPWARD_
#define _MANAGEMENT_QUEUETHRESHOLDCROSSEDUPWARD_
...
QPID_BROKER_CLASS_EXTERN class EventQueueThresholdCrossedUpward : public ::qpid::management::ManagementEvent
{
  private:
...
#endif  /*!_MANAGEMENT_QUEUETHRESHOLDCROSSEDUPWARD_*/
