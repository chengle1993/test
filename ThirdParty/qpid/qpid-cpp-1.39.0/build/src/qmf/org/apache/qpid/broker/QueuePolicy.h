...
#ifndef _MANAGEMENT_ORG_APACHE_QPID_BROKER_QUEUEPOLICY_
#define _MANAGEMENT_ORG_APACHE_QPID_BROKER_QUEUEPOLICY_
...
QPID_BROKER_CLASS_EXTERN class QueuePolicy : public ::qpid::management::ManagementObject
{
  private:
...
#endif  /*!_MANAGEMENT_QUEUEPOLICY_*/
