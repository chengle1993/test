...
Outgoing::Outgoing (ManagementAgent*, Manageable* _core, ::qpid::management::Manageable* _parent, const std::string& _containerid, const std::string& _name, const std::string& _source, const std::string& _target, const std::string& _domain) :
