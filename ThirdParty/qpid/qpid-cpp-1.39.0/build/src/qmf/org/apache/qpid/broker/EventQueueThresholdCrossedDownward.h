...
#ifndef _MANAGEMENT_QUEUETHRESHOLDCROSSEDDOWNWARD_
#define _MANAGEMENT_QUEUETHRESHOLDCROSSEDDOWNWARD_
...
QPID_BROKER_CLASS_EXTERN class EventQueueThresholdCrossedDownward : public ::qpid::management::ManagementEvent
{
  private:
...
#endif  /*!_MANAGEMENT_QUEUETHRESHOLDCROSSEDDOWNWARD_*/
