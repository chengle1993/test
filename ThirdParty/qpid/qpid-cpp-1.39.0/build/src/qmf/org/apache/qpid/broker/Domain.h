...
#ifndef _MANAGEMENT_ORG_APACHE_QPID_BROKER_DOMAIN_
#define _MANAGEMENT_ORG_APACHE_QPID_BROKER_DOMAIN_
...
QPID_BROKER_CLASS_EXTERN class Domain : public ::qpid::management::ManagementObject
{
  private:
  ...
  public:
    ...
    QPID_BROKER_EXTERN Domain(
        ...
        ::qpid::management::Manageable* coreObject, const std::string& _name, bool _durable);
