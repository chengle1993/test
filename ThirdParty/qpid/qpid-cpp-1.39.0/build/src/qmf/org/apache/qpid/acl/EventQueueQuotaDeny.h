...
#ifndef _MANAGEMENT_QUEUEQUOTADENY_
#define _MANAGEMENT_QUEUEQUOTADENY_
...
QPID_BROKER_CLASS_EXTERN class EventQueueQuotaDeny : public ::qpid::management::ManagementEvent
{
  private:
...
#endif  /*!_MANAGEMENT_QUEUEQUOTADENY_*/
