...
#ifndef _MANAGEMENT_MEMBERSUPDATE_
#define _MANAGEMENT_MEMBERSUPDATE_
...
QPID_BROKER_CLASS_EXTERN class EventMembersUpdate : public ::qpid::management::ManagementEvent
{
  private:
    ...
    const ::qpid::types::Variant::List& members;


  public:
    writeSchemaCall_t getWriteSchemaCall(void) { return writeSchema; }

    QPID_BROKER_EXTERN EventMembersUpdate(const ::qpid::types::Variant::List& _members);
    QPID_BROKER_EXTERN ~EventMembersUpdate() {};
...
#endif  /*!_MANAGEMENT_MEMBERSUPDATE_*/
