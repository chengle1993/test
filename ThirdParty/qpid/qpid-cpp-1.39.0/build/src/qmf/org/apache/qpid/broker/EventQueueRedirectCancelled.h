...
#ifndef _MANAGEMENT_QUEUEREDIRECTCANCELLED_
#define _MANAGEMENT_QUEUEREDIRECTCANCELLED_
...
QPID_BROKER_CLASS_EXTERN class EventQueueRedirectCancelled : public ::qpid::management::ManagementEvent
{
  private:
...
#endif  /*!_MANAGEMENT_QUEUEREDIRECTCANCELLED_*/
